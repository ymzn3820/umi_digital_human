        ...
        <div class="pageOne-content">
          ...
          <div class="created-audio">
            ...
            <div>
              <div
                class="aduio-uoload"
                style="height: auto; position: relative; left: 37px"
              >
                <!-- <i class="el-icon-upload"></i> -->
          ...
          <div class="created-pay">
              ...
              <div>
                <div class="domHover" @click.self="handleAudio('audio1')">
                  ...
                  <i
                    ...
                    @click="handleAudio('audio1')"
                    v-if="stopCase1"
                  ></i>
                  <i
                    class="el-icon-video-pause"
                    @click="handleStopCase('audio1')"
                    v-else
                  ></i>
                  <audio
                    ref="audio1"
                    src="https://umi-intelligence.oss-cn-shenzhen.aliyuncs.com/xcx/com/message_center/案例原声音.wav"
                  ></audio>
                </div>
                <div class="domHover" @click.self="handleAudio('audio2')">
                  ...
                  <i
                    class="el-icon-video-play"
                    @click="handleAudio('audio2')"
                    v-if="stopCase2"
                  ></i>
                  <i
                    class="el-icon-video-pause"
                    @click="handleStopCase('audio2')"
                    v-else
                  ></i>
                  <audio
                    ref="audio2"
                    src="https://umi-intelligence.oss-cn-shenzhen.aliyuncs.com/xcx/com/message_center/案例克隆声音.wav"
                  ></audio>
                </div>
              </div>
            </div>
            <div class="pay">
              <div class="pay-left">
                <div>
                  付款定制，即可快速复刻，拥有高品质Al定制音色，实现你的专属发音播稿
                </div>
                <div>
                  <el-checkbox v-model="checked"></el-checkbox>
                  <div>
                    我已阅读并同意<span @click="showArgee"
                      >《定制数字人协议》</span
                    >
                  </div>
                </div>
